...
//========================================================================================
	...
	Flux<User> fluxWithDoOnPrintln() {
		return repository.findAll()
                .doOnSubscribe(any -> System.out.println("Starring"))
                .doOnNext(user -> System.out.println("firstname: "+ user.getUsername() + ", lastname: " + user.getLastname()))
                .doOnComplete(() -> System.out.printf("The end"));
	}
